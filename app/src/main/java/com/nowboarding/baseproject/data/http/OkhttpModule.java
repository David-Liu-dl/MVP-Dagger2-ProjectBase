...
import com.nowboarding.baseproject.util.HttpUtil;
...
public class OkhttpModule {
    ...
    @Provides
    @Named("cache")
    public OkHttpClient providerAutoCacheOkHttpClient(Context context, com.nowboarding.baseproject.function.Authenticator authenticator){
    ...
    @Provides
    @Named("default")
    public OkHttpClient providerOkHttpClient(Context context, com.nowboarding.baseproject.function.Authenticator authenticator, ConstantInterface constantInterface){
        HttpLoggingInterceptor interceptor = new HttpLoggingInterceptor();
        interceptor.setLevel(HttpLoggingInterceptor.Level.BODY);
